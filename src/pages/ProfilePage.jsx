...
const ProfilePage = () => {
  ...
  const [newFullName, setNewFullName] = useState(authUser?.fullName || ""); // State for new full name
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="relative">
              <img
                ...
                alt="Profile"
                className="size-32 rounded-full object-cover border-4 z-10 "
              />
              <label
              ...
              {isEditingName ? (
                ...
                <div className="flex items-center justify-between px-4 py-2.5 bg-base-200 rounded-lg border">
                  ...
                  <button
                    ...
                    className="p-2 hover:bg-base-100 rounded-lg transition-all"
                  >
